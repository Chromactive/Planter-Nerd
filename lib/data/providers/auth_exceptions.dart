class AuthExceptions {
  ...
  static const String messageEmailUsed = 'An account with that email address already exists';
  ...
  static const String messageUserNotFound = 'No user with that email address was found';
  static const String messageRequestFailed = 'Request failed. Try again later';

  bool shouldDisplayUser(String code) {
